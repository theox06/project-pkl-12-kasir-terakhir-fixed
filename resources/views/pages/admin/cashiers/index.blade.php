                    ...
                    <tr class="align-middle">
                        ...
                        <td>
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('kasir.edit', $item->id) }}" class="btn btn-warning btn-sm py-1 px-3 rounded-1 text-white">
                                    <i class="bx bx-edit"></i> Edit
                                </a>
                                <form action="{{ route('kasir.destroy', $item->id) }}" method="POST">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="btn btn-light btn-sm py-1 px-3 rounded-1" onclick= "return confirm ('Perhatian, data akan terhapus secara permanen!')">
