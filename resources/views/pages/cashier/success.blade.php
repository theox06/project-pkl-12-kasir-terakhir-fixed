                ...
                <div class="card border-0">
                    <div class="card-body py-5 px-5">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-5">
                                <p class="mb-0 text-dark text-end fw-semibold">Rp. {{ number_format($item->price * $item->quantity) }}</p>
                                <p class="mb-0 text-secondary text-end fs-7">{{ $item->quantity }}</p>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-2">
                            ...
                            <p class="mb-0 text-dark fw-semibold">Rp. {{ number_format($transaction->total - 12000) }}</p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-2">
